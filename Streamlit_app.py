...
image1 = Image.open('Final_DA_streamlit/Map avg price by city.jpg')
st.image(image1, caption = 'USA')

#House price visualization
st.subheader("House price visualization :ocean:")
image2 = Image.open('Final_DA_streamlit/House_sale_visualization.png')
...
label_encoder = load(open("Final_DA_streamlit/city_encoder.pkl", 'rb'))
